...
def analyze_with_deepseek(deepseek_client, price_data, generate_technical_analysis_text, get_recent_ai_analysis, get_recent_trades, signal_history):
...
def analyze_with_deepseek_with_retry(deepseek_client, price_data, generate_technical_analysis_text, get_recent_ai_analysis, get_recent_trades, signal_history, max_retries=2):
    ...
    for attempt in range(max_retries + 1):
        try:
            signal_data = analyze_with_deepseek(deepseek_client, price_data, generate_technical_analysis_text, get_recent_ai_analysis, get_recent_trades, signal_history)
